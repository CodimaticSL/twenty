...
When you start using NodiaFlow, you'll want to get your contacts and companies into the system. There are several ways to populate your CRM depending on your workflow and data sources.

### Manual entry

The most straightforward approach is adding records directly through the NodiaFlow interface. Go to the `People` section and click the `+` button to add a new contact. Fill in their name, email, phone, and link them to their company. For companies, head to the `Companies` section and add the organization details: company name, domain, industry, and size.
...
For ongoing lead generation, you can set up automated workflows that bring data directly into NodiaFlow:

**Website forms**: When someone fills out a form on your website, you can configure it to send the information to NodiaFlow automatically. The form submission triggers a webhook that activates a workflow in NodiaFlow, creating the new contact record without any manual work.

**Integration with other systems**: If you use other business tools, you can connect them to NodiaFlow using API calls and workflows. This lets you automatically sync data between systems: for example, bringing in new customers from your billing system or leads from your marketing platform.
...
When you connect your mailbox and calendar to NodiaFlow, the system can automatically create People and Companies records for people you email or meet with. If you send an email to someone who isn't already in your CRM, NodiaFlow can create a new Person record for them. The same happens when you schedule meetings with new contacts through your calendar.

This is particularly useful for sales and business development teams who are constantly meeting new people. Instead of manually adding every new contact, NodiaFlow captures them automatically as you communicate. Learn how to set this up in our [Emails and Calendars](/user-guide/section/collaboration/emails-and-calendars) guide.
...
NodiaFlow automatically enforces uniqueness to keep your data organized. Each person's email address serves as a unique identifier: you can't have two people with the same email. Similarly, company domains are unique, so you won't accidentally create duplicate companies.
...
Sometimes you'll end up with duplicate records. NodiaFlow has a merge feature for both People and Companies: you can combine duplicate records to keep your database clean without losing any information.
...
The Email and Calendar tabs are particularly powerful: they automatically show all email exchanges and meetings that anyone on your team has had with this contact, as long as they've connected their mailbox to NodiaFlow. You can learn more about setting this up in our [Emails and Calendars](/user-guide/section/collaboration/emails-and-calendars) guide.
...
When you delete a record in NodiaFlow, it's not gone forever. Records are "soft deleted," which means they're hidden but can be restored if needed.
