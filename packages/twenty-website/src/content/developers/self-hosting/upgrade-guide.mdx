...
1. In a terminal, on the host where NodiaFlow is running, turn off NodiaFlow: `docker compose down`
...
3. Bring NodiaFlow back online with `docker compose up -d`
...
Upgrade your NodiaFlow instance to use v0.55 image
...
This issue is specific to this NodiaFlow version and should not be required for future upgrades.
...
It should always be in the range of your current NodiaFlow's instance `major.minor` version, you can view your instance version in the admin panel (at `/settings/admin-panel`, accessible if your user has `canAccessFullAdminPanel` property set to true in the database) or by running `echo $APP_VERSION` in your `twenty-server` container.
...
Upgrade your NodiaFlow instance to use v0.52 image
...
Upgrade your NodiaFlow instance to use v0.51 image
...
Upgrade your NodiaFlow instance to use v0.50.0 image
...
Upgrade your NodiaFlow instance to use v0.44.0 image
...
Upgrade your NodiaFlow instance to use v0.43.0 image
...
Upgrade your NodiaFlow instance to use v0.42.0 image
...
Upgrade your NodiaFlow instance to use v0.41.0 image
...
Upgrade your NodiaFlow instance to use v0.40.0 image
...
Upgrade your NodiaFlow instance to use v0.35.0 image
...
Upgrade your NodiaFlow instance to use v0.34.0 image
...
Upgrade your NodiaFlow instance to use v0.33.0 image
...
Upgrade your NodiaFlow instance to use v0.32.0 image
...
Upgrade your NodiaFlow instance to use v0.31.0 image
...
Upgrade your NodiaFlow instance to use v0.30.0 image

**Breaking change**:
To enhance performances, NodiaFlow now requires redis cache to be configured. We have updated our [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/twenty/main/packages/twenty-docker/docker-compose.yml) to reflect this.
...
Upgrade your NodiaFlow instance to use v0.24.0 image
...
Upgrade your NodiaFlow instance to use v0.23.0 image
...
Upgrade your NodiaFlow instance to use v0.22.0 image
