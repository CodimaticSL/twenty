...
export const rule = ESLintUtils.RuleCreator(() => __filename)({
  ...
  meta: {
    ...
    messages: {
      test: 'test',
      noStateUseRef:
        "Don't use useRef for state management. See https://docs.nodiaflow.com/developer/frontend/best-practices#do-not-use-useref-to-store-state for more details.",
    },
    type: 'suggestion',
    schema: [],
  },
