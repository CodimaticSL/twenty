...
info: Step-by-step guide for migrating data and processes from other CRM systems to NodiaFlow.
image: /images/user-guide/what-is-twenty/migrating_crm.png
sectionInfo: A brief guide to grasp the basics of NodiaFlow
---
...
- **Map existing fields** to NodiaFlow's standard objects / fields
...
- **Use NodiaFlow's workflow builder** to replace existing automations
...
- **Use NodiaFlow IDs** for complex relationships
...
If you're moving from NodiaFlow self-hosted to NodiaFlow Cloud:
