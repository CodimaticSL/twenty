        ...
        "node": {
          ...
          "fieldsList": [
            ...
            },
            {
              ...
              "relation": null,
              "label": "Secret",
              "description": "Optional secret used to compute the HMAC signature for webhook payloads. This secret is shared between NodiaFlow and the webhook consumer to authenticate webhook requests.",
              "icon": "IconLock"
            },
            {
              "__typename": "Field",
