...
NodiaFlow automatically links emails from your connected mailboxes to the relevant CRM records, keeping all communication history in one place.
...
- **Missing Emails**: Check if:
  ...
  - Contact auto-creation is disabled (emails need existing NodiaFlow records)
