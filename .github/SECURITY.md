...
- Include a comprehensive description of the potential vulnerability and steps to reproduce the issue, if possible. The more information you can provide, the quicker NodiaFlow can address the problem.
...
While NodiaFlow doesn't have a formal bug bounty program right now due to the project's nascent stage, rest assured that:
...
- Your contribution is greatly appreciated, and NodiaFlow would acknowledge your role in the vulnerability fix, if you opt for identification.
- NodiaFlow will grant you permission to publicly discuss your findings once users have had a reasonable time to apply the patch after it becomes available.
- NodiaFlow guarantees not to pursue any legal action as long as the vulnerability is not exploited.
