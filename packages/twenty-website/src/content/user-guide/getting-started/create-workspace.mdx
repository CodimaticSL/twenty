...
info: "Follow a step-by-step guide on how to register on NodiaFlow, choose a subscription plan, confirm your payment and set up your account, with additional advice on seeking assistance if needed."
icon: IconNote
...
## Step 1: Registration
1. Navigate to <ArticleLink href="https://app.nodiaflow.com">NodiaFlow Sign Up</ArticleLink>.
...
## Support
For queries or help, connect with the dedicated support team at [contact@nodiaflow.com](mailto:contact@nodiaflow.com) or send a message on <ArticleLink href="https://discord.gg/cx5n4Jzs57">Discord</ArticleLink>
