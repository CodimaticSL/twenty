...
Every business works differently. That's why NodiaFlow lets you shape the CRM around your needs, not force your processes into ours.
**Start with these three steps to set it up your way.**

**Quick Win**: Start with connecting your mailbox and customizing your data model with a few key fields. This gives you immediate value and helps your team see NodiaFlow in action with real data. You can do so under Settings → Accounts.

## 1. Customize your data model
NodiaFlow offers the flexibility you need to shape the data model that will best support your day-to-day.
...
Bringing your existing data into NodiaFlow gives your team context from the start.

### Connect your mailbox
If you have not done so when creating your workspace, connect your **Google or Microsoft account** under Settings → Accounts. This allows NodiaFlow to:
