# Contributing to NodiaFlow

Thanks for considering contributing to NodiaFlow!

Please make sure to go through the [documentation](https://docs.nodiaflow.com) before.
...
1. For `Good First Issue` and `Experienced Contributor` issues without `size: long` labels, we'll merge the first PRs that meet our [code quality standards](https://nodiaflow.com/developers). **We don't assign contributors to these issues**. For `priority: high` issues, our core team will step in within days if no adequate contributions are received.
...
4. **Make Changes:** Make your desired changes and ensure that your code adheres to NodiaFlow's coding standards.
...
8. **Create a Pull Request:** Go to the original NodiaFlow repository and create a pull request. Please provide a detailed description of your changes. Submitting a PR means you agree to the CLA.
...
If you face any issues or have suggestions, please feel free to (create an issue on NodiaFlow's GitHub repository)[https://github.com/twentyhq/twenty/issues/new]. Please provide as much detail as possible.
