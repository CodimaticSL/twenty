---
title: Glossary
info: "Get familiar with essential terminology used in NodiaFlow."
icon: IconVocabulary
...
## API
API (Application Programming Interface) allows you to connect NodiaFlow with other software systems and build custom integrations.
...
## Integration
Integration are built-in tools that allow to link NodiaFlow with other software or systems.
...
## Opportunities
Opportunities in NodiaFlow CRM are potential deals or sales with accounts or contacts.
...
## Tasks
Tasks in NodiaFlow CRM are assigned activities relating to contacts, accounts, or opportunities.
...
## Webhooks
Webhooks are automated messages sent from NodiaFlow to other applications when specific events occur, enabling real-time data synchronization.
...
## Workspace
A `Workspace` typically represents a company using NodiaFlow. It holds all the records and data that you and your team members add to NodiaFlow.
It has a single domain name, which is typically the domain name your company uses for employee email addresses.

## Workspace Members
Workspace Members are the NodiaFlow users from your team who have access to your workspace. They can be assigned as owners or assignees for records.
