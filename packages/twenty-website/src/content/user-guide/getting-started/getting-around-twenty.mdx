---
title: Getting around NodiaFlow
...
When you log into NodiaFlow for the first time, the layout should feel intuitive. It’s designed to help you move fast and stay organized, without getting in your way.
...
The command menu gives you **quick access to actions and search** in NodiaFlow. You can access it in two ways:
...
- Create new views
- Access deleted records (NodiaFlow supports soft and hard deletes)
...
If you're new to Views, read <ArticleLink href="https://nodiaflow.com/user-guide/section/crm-essentials/view-management">our View Management article</ArticleLink> to learn how to create and customize them.
