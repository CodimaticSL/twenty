...
describe('ActivityQueryResultGetterHandler', () => {
  ...
  beforeEach(async () => {
    process.env.SERVER_URL = 'https://my-domain.nodiaflow.com';
    ...
    it('when file link is in the body', async () => {
      const imageBlock = {
        ...
        props: {
          ...
          textAlignment: 'left',
          name: '20240529_123208.jpg',
          url: 'https://my-domain.nodiaflow.com/files/attachment/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..qTN1b9IcmZvfVAqt1UlfJ_nn3GwIAEp7G9IoPtRJDxk/e45cb48a-362f-4e8f-b913-c92b5e3e0aa6.jpg',
          caption: '',
          showPreview: true,
        },
        children: [],
          ...
          blocknote: JSON.stringify([
            {
              ...
              props: {
                ...imageBlock.props,
                url: 'https://my-domain.nodiaflow.com/files/signed-path',
              },
            },
          ]),
        },
