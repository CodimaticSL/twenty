...
const fetchContributorStats = async (username: string) => {
  const apiUrl = `https://nodiaflow.com/api/contributors/contributorStats/${username}`;
...
const fetchContributorImage = async (username: string) => {
  const apiUrl = `https://nodiaflow.com/api/contributors/${username}/og.png`;
...
const runCongratulate = async () => {
  ...
  const contributorUrl = `https://nodiaflow.com/contributors/${userName}`;
  ...
  const message =
    ...
    `![Contributions](https://nodiaflow.com/api/contributors/${userName}/og.png)`;
