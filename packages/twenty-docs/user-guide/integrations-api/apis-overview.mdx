...
sectionInfo: Learn how to connect NodiaFlow to your other tools.
---
<Frame>
  <img src="/images/user-guide/api/api-overview.png" alt="Header" />
</Frame>

NodiaFlow was built to be developer-friendly, offering powerful APIs that adapt to your custom data model. We provide four distinct API types to meet different integration needs.

## Developer-First Approach

NodiaFlow generates APIs specifically for your data model, meaning:
...
NodiaFlow offers APIs in both **REST** and **GraphQL** formats:
