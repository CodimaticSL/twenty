...
<ArticleWarning>
**First time installing?** Follow the [Docker Compose installation guide](https://nodiaflow.com/developers/section/self-hosting/docker-compose) to get NodiaFlow running, then return here for configuration.
</ArticleWarning>

NodiaFlow offers **two configuration modes** to suit different deployment needs:
...
1. Access your NodiaFlow instance (usually `http://localhost:3000`)
...
<ArticleWarning>
Users must have a [Microsoft 365 Licence](https://admin.microsoft.com/Adminportal/Home) to be able to use the Calendar and Messaging API. They will not be able to sync their account on NodiaFlow without one.
</ArticleWarning>
