...
Read [this article](https://nodiaflow.com/user-guide/section/integrations/import-export-data) to learn more about Data import / export via csv.  
...
Read [this article](https://nodiaflow.com/user-guide/section/data-model/customize-your-data-model) to learn how to design your data model.  
...
## What's next?
Start creating automations using <ArticleLink href="https://nodiaflow.com/user-guide/section/integrations/getting-started-workflows">workflows</ArticleLink>.
