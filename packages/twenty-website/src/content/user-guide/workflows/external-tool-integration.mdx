...
icon: IconPlug
info: These workflows focus on bringing data in and out of NodiaFlow through API calls and webhooks.
image: /images/user-guide/integrations/plug.png
sectionInfo: Automate processes and integrate with external tools
---
Below are workflow examples you could roll out to connect NodiaFlow with the rest of your stack.


## Data Ingestion Use Cases

### Webform Submissions
**Problem**: You need to capture leads from website forms, landing pages, or contact forms directly into NodiaFlow.
...
**Solution**: Regularly sync product data into NodiaFlow to give sellers context about their accounts.
...
**Setup**: Create a view in NodiaFlow with all newsletter recipients
...
### Bi-directional Sync
**Problem**: You need to keep data synchronized between NodiaFlow and another system in both directions.

**Solution**: Combine scheduled workflows with webhook triggers for real-time sync.

**From NodiaFlow to External System**:
...
**From External System to NodiaFlow**:
...
**Problem**: Data from external sources needs complex processing before it can be used in NodiaFlow.
