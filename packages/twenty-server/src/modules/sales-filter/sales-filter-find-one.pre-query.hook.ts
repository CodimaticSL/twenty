  ...
  implements WorkspacePreQueryHookInstance
{
  constructor(
    ...
    // Constructor sin logs de depuración
  }
  ...
  async execute(
    ...
    if (shouldApplySalesFilter) {
      ...
      // Filtro combinado aplicado sin logs
   ...
   * - Si existe createdBy y responsable: filtrar por responsable con fallback a createdBy
  ...
  private buildCombinedFilter(
    ...
    // Construyendo filtro combinado - sin logs
